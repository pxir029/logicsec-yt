...
<div class="wrap">
  <div class="card">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,__LOGO_B64__" alt="Agex"></div>
      <div><div class="brand-name">Agex</div><div class="brand-sub">v9.5</div></div>
    </div>
    <h1>ورود به پنل</h1>
    ...
    <div class="hint">
      ...
      <span class="hint-val" onclick="document.getElementById('pw').value='agexplus';document.getElementById('pw').focus()">agexplus</span>
    </div>
    <form id="form">
      <div class="field">
    ...
    <div class="footer">پشتیبانی <a href="https://t.me/Pixonal" target="_blank"><i class="ti ti-brand-telegram"></i>@Pixonal</a></div>
  </div>
</div>
<script>
...
<div class="mob-top">
  <div class="ml">
    <div class="mob-logo"><img src="data:image/png;base64,__LOGO_B64__" alt="Agex"></div>
    <span class="mob-title">Agex</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    <div class="logo-img"><img src="data:image/png;base64,__LOGO_B64__" alt="Agex"></div>
    <div><div class="logo-name">Agex</div><div class="logo-sub">v9.5</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">Agex v9.5 · Railway</span>
    <a class="df-link" href="https://t.me/Pixonal" target="_blank"><i class="ti ti-brand-telegram"></i> t.me/Pixonal</a>
...
<section class="pg" id="pg-links">
  ...
  <div class="create-panel">
    ...
    <div class="cp-body">
      <div class="cp-row">
        <div class="cp-block">
          <div class="cp-block-label"><i class="ti ti-id-badge-2"></i> شناسه کانفیگ <button type="button" class="btn btn-o btn-sm" style="margin-right:8px;padding:2px 8px;font-size:10px" onclick="randomLabel()"><i class="ti ti-dice"></i> رندوم</button></div>
          <input class="cp-input-full" id="nl-label" placeholder="مثلاً: کاربر علی · یا رندوم بزن">
...
<script>
let isDark=localStorage.getItem('agex-theme')!=='light';
...
function toggleTheme(){isDark=!isDark;localStorage.setItem('agex-theme',isDark?'dark':'light');applyTheme(isDark)}
applyTheme(isDark);
function randomLabel(){
  const names=["User","Client","VIP","Pro","Gold","Silver","Premium","Elite","Fast","Secure","Cloud","Node","Link","Gate","Tunnel","Proxy","Net","Web","X","A"];
  const nums=Math.floor(Math.random()*9000)+1000;
  const name=names[Math.floor(Math.random()*names.length)]+"-"+nums;
  document.getElementById("nl-label").value=name;
}
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,{LOGO_B64}" alt="Agex"></div>
      <div><div class="brand-name">Agex</div><div class="brand-sub">v9.5</div></div>
    </div>
  ...
  <div class="footer">پشتیبانی: <a href="https://t.me/Pixonal" target="_blank">@Pixonal</a> · Agex v9.5</div>
</div>
<script>
const UUID_KEY='{uuid_key}';
let savedPw='';

let isDark=localStorage.getItem('agex-pub-theme')!=='light';
function applyTheme(dark){{
  document.documentElement.setAttribute('data-theme',dark?'dark':'light');
  document.getElementById('theme-icon').className='ti '+(dark?'ti-sun':'ti-moon');
}}
function toggleTheme(){{isDark=!isDark;localStorage.setItem('agex-pub-theme',isDark?'dark':'light');applyTheme(isDark)}}
applyTheme(isDark);
...
function renderContent(d){{
  ...
  window._agexSubUrl  = subUrl;
  window._agexSubName = d.name;
  window._agexLinks   = d.links.map(l => ({{
    vless : l.vless_link,
    ...
    <div class="sub-info">
      ...
      <div class="sub-sub-box">
        ...
        <button class="btn btn-pur" style="padding:7px 12px;font-size:10.5px"
          onclick="navigator.clipboard.writeText(window._agexSubUrl).then(()=>toast('لینک ساب کپی شد ✓','ok'))">
          <i class="ti ti-copy"></i> کپی لینک ساب
        </button>
        <button class="btn btn-g" style="padding:7px 12px;font-size:10.5px"
          onclick="showQR(window._agexSubName + ' — کل گروه', window._agexSubUrl)">
            ...
            <div class="cfg-bottom">
              ...
              <div class="cfg-actions">
                <button class="btn btn-p"
                  onclick="navigator.clipboard.writeText(window._agexLinks[${{i}}].vless).then(()=>toast('لینک کپی شد ✓','ok'))">
                  <i class="ti ti-copy"></i> کپی لینک
                </button>
                <button class="btn btn-g"
                  onclick="showQR(window._agexLinks[${{i}}].label, window._agexLinks[${{i}}].vless)">
