...
> **تغییرات این نسخه:**
> - دکمه قرمز **«بهترین تنظیمات خودکار»** در پایین فرم ساخت کانفیگ
> - حذف پروتکل ناقص `xhttp-stream-one` و تثبیت کامل دو پروتکل **XHTTP packet-up** و **XHTTP stream-up**
> - لینک‌سازی XHTTP سخت‌گیرانه‌تر و سازگارتر با کلاینت‌ها
> - ربات تلگرام تقویت‌شده: استارت مطمئن‌تر + دکمه **«بهترین تنظیمات خودکار»** یک‌کلیکی
> - آماده دیپلوی مستقیم روی Railway
