...
<script>
(function(){try{var t=localStorage.getItem('pxpanel_theme')||'dark';document.documentElement.setAttribute('data-theme',t);}catch(e){}})();
</script>
...
:root, [data-theme="dark"] {
  --t-bg: #07070a;
  --t-bg-grad1: rgba(37,99,235,.13);
  --t-bg-grad2: rgba(59,130,246,.10);
  --t-text: #ffffff;
  --t-text-2: rgba(255,255,255,.82);
  --t-muted: rgba(255,255,255,.37);
  --t-muted-2: rgba(255,255,255,.32);
  --t-muted-3: rgba(255,255,255,.45);
  --t-border: rgba(255,255,255,.08);
  --t-border-2: rgba(255,255,255,.07);
  --t-border-3: rgba(255,255,255,.06);
  --t-card: rgba(255,255,255,.03);
  --t-card-2: rgba(255,255,255,.035);
  --t-card-3: rgba(255,255,255,.025);
  --t-card-4: rgba(255,255,255,.05);
  --t-accent: #60a5fa;
  --t-accent-2: #93c5fd;
  --t-danger: #fca5a5;
  --t-success: #86efac;
  --t-success-bg: rgba(34,197,94,.08);
  --t-danger-bg: rgba(239,68,68,.08);
  --t-modal-bg: #0d0d12;
  --t-modal-overlay: rgba(0,0,0,.72);
  --t-input-bg: rgba(255,255,255,.04);
  --t-input-border: rgba(255,255,255,.1);
  --t-scroll: rgba(255,255,255,.12);
  --t-scroll-hover: rgba(255,255,255,.2);
  --t-shadow: 0 20px 50px rgba(0,0,0,.45);
  --t-top-btn: rgba(255,255,255,.035);
  --t-logo-shadow: 0 8px 24px rgba(37,99,235,.35);
}

[data-theme="light"] {
  --t-bg: #f1f5f9;
  --t-bg-grad1: rgba(37,99,235,.08);
  --t-bg-grad2: rgba(99,102,241,.06);
  --t-text: #0f172a;
  --t-text-2: #1e293b;
  --t-muted: #64748b;
  --t-muted-2: #64748b;
  --t-muted-3: #475569;
  --t-border: rgba(15,23,42,.1);
  --t-border-2: rgba(15,23,42,.08);
  --t-border-3: rgba(15,23,42,.07);
  --t-card: #ffffff;
  --t-card-2: #ffffff;
  --t-card-3: #f8fafc;
  --t-card-4: #f1f5f9;
  ...
  --t-danger: #dc2626;
  --t-success: #059669;
  --t-success-bg: rgba(5,150,105,.1);
  --t-danger-bg: rgba(220,38,38,.08);
  --t-modal-bg: #ffffff;
  --t-modal-overlay: rgba(15,23,42,.45);
  --t-input-bg: #f8fafc;
  --t-input-border: rgba(15,23,42,.12);
  --t-scroll: rgba(15,23,42,.15);
  --t-scroll-hover: rgba(15,23,42,.28);
  --t-shadow: 0 16px 40px rgba(15,23,42,.12);
  --t-top-btn: #ffffff;
  --t-logo-shadow: 0 8px 20px rgba(37,99,235,.25);
}
...
body{
    ...
    font-family:"Vazirmatn",sans-serif;
    background:
        radial-gradient(circle at 10% 0%, var(--t-bg-grad1), transparent 25%),
        radial-gradient(circle at 100% 100%, var(--t-bg-grad2), transparent 25%),
        var(--t-bg);
    transition: background .35s ease, color .25s ease;
}

*::-webkit-scrollbar-thumb{background:var(--t-scroll)!important}
*::-webkit-scrollbar-thumb:hover{background:var(--t-scroll-hover)!important}
*{scrollbar-color:var(--t-scroll) transparent !important}

.brand-name{color:var(--t-text)!important}
.brand-desc{color:var(--t-muted)!important}
.brand-version{color:var(--t-accent)!important}
.logo{box-shadow:var(--t-logo-shadow)}

.top-btn{
    border:1px solid var(--t-border)!important;
    color:var(--t-text)!important;
    background:var(--t-top-btn)!important;
    box-shadow:0 1px 2px rgba(0,0,0,.04);
    transition: all .2s ease;
}
.top-btn:hover{filter:brightness(1.05)}
.top-btn.primary{
    background:linear-gradient(135deg,#2563eb,#3b82f6)!important;
    color:#fff!important;
    border-color:transparent!important;
}
.top-btn.danger{color:var(--t-danger)!important}

.stat{
    border:1px solid var(--t-border-2)!important;
    background:var(--t-card)!important;
    box-shadow:var(--t-shadow);
}
.stat-label{color:var(--t-muted)!important}
[data-theme="light"] .stat-value{filter:none}
[data-theme="light"] .stat{box-shadow:0 4px 16px rgba(15,23,42,.06)}
...
[data-theme="light"] .panel{box-shadow:0 4px 18px rgba(15,23,42,.06)}
.panel-head{border-bottom:1px solid var(--t-border-3)!important}
.panel-title{color:var(--t-text)!important}
.panel-sub{color:var(--t-muted-2)!important}

table th{color:var(--t-muted)!important;background:var(--t-card-4)!important}
table td{color:var(--t-text-2)!important;border-color:var(--t-border-3)!important}
[data-theme="light"] table tr:hover td{background:rgba(37,99,235,.04)!important}

.badge-on,.status-on{color:var(--t-success)!important;background:var(--t-success-bg)!important}
.badge-off,.status-off{color:var(--t-danger)!important;background:var(--t-danger-bg)!important}

.action-btn, .mini-btn, .icon-btn{
    color:var(--t-accent-2)!important;
    background:var(--t-card-4)!important;
    border:1px solid var(--t-border)!important;
}
.action-btn.danger, .mini-btn.danger{color:var(--t-danger)!important}

.modal-backdrop{background:var(--t-modal-overlay)!important}
.modal{
...
.modal-title{color:var(--t-text)!important}
.modal .close, .modal-head button{
    color:var(--t-text)!important;
    background:var(--t-card-4)!important;
    border:1px solid var(--t-border)!important;
}
.field label{color:var(--t-muted-3)!important}
...
.field input::placeholder, input::placeholder{color:var(--t-muted)!important}
.modal-btn.secondary{
    background:var(--t-card-4)!important;
    color:var(--t-text)!important;
    border:1px solid var(--t-border)!important;
...
/* support panel theme */
.support-panel{
    background:linear-gradient(165deg, var(--t-modal-bg) 0%, var(--t-card-3) 100%)!important;
    border-color:var(--t-border)!important;
}
.support-panel-title{color:var(--t-text)!important}
.support-panel-sub{color:var(--t-muted)!important}
.support-tile{
    background:var(--t-card-4)!important;
    border-color:var(--t-border)!important;
}
.support-tile-label{color:var(--t-text)!important}
.support-tile-val{color:var(--t-muted)!important}
[data-theme="light"] .support-panel-head{
    background:linear-gradient(135deg,rgba(37,99,235,.12),rgba(99,102,241,.08))!important;
}
...
[data-theme="light"] body{
    background:
        ...
        radial-gradient(circle at 100% 100%, rgba(99,102,241,.05), transparent 28%),
        #f1f5f9 !important;
}
[data-theme="light"] .top-btn[style*="purple"],
[data-theme="light"] .top-btn[style*="139,92,246"]{
    background:rgba(139,92,246,.1)!important;
    color:#6d28d9!important;
}
[data-theme="light"] a.top-btn[href*="reymit"]{
    background:linear-gradient(135deg,rgba(236,72,153,.12),rgba(244,63,94,.1))!important;
    color:#db2777!important;
}
[data-theme="light"] code, [data-theme="light"] .mono{
    background:rgba(15,23,42,.05)!important;
    color:#1e40af!important;
}
[data-theme="light"] .login-notice-body,
[data-theme="light"] .region-warning{
...
<div class="brand-version">13.9.0</div>
...
<button type="button" class="top-btn theme-toggle-btn" id="themeToggleBtn" onclick="togglePanelTheme()" title="تغییر تم" aria-label="تغییر تم">
  <svg class="icon-moon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 14.5A8.5 8.5 0 1 1 9.5 3 7 7 0 0 0 21 14.5z"/></svg>
...
(function initTheme(){
  try{
    var saved = localStorage.getItem('pxpanel_theme') || 'dark';
...
function togglePanelTheme(){
  ...
  try{ localStorage.setItem('pxpanel_theme', next); }catch(e){}
  if(typeof showToast === 'function'){
    showToast(next === 'light' ? 'تم روشن فعال شد' : 'تم تاریک فعال شد');
  }
}
